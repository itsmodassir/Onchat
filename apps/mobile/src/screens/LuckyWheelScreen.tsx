...
const LuckyWheelScreen = () => {
  ...
  const prizes = [
    { name: '10 Coins', icon: 'cash' },
    { name: '50 Coins', icon: 'cash' },
    { name: '100 Coins', icon: 'cash' },
    { name: '500 Coins', icon: 'sparkles' },
    { name: 'Headwear', icon: 'shirt' },
    { name: 'Try Again', icon: 'refresh' },
  ];
  ...
  const spin = async () => {
    ...
    try {
      // Call the secure spin API to deduct stake and calculate server-side prize

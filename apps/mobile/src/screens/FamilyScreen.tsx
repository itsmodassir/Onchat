...
import { ChevronLeft, Search, Calendar, Check, Gift, ChevronRight, Users } from 'lucide-react-native';
              ...
              {[9, 10, 11, 12, 13, 14].map((day) => (
                <View key={day} style={styles.dayItem}>
                   <View style={[styles.checkCircle, day < 13 && styles.checkedCircle]}>
                      {day < 14 ? <Check size={16} color="#FFF" /> : <Gift size={16} color="#FF6F00" />}
                   </View>
...
const styles = StyleSheet.create({
  ...
  familyInfo: { marginTop: -40, backgroundColor: '#F5F5F5', borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 16 },
  familyMain: { flexDirection: 'row', alignItems: 'center', marginBottom: 16 },
  familyLogo: { width: 60, height: 60, borderRadius: 12, borderWidth: 2, borderColor: '#FFF' },
  familyDetail: { flex: 1, marginLeft: 12 },
  familyName: { fontSize: 20, fontWeight: 'bold', color: '#333' },
  familyId: { fontSize: 12, color: '#666' },
  rankBadge: { backgroundColor: '#FFD700', paddingHorizontal: 12, paddingVertical: 4, borderRadius: 12 },
  rankText: { fontSize: 12, fontWeight: 'bold', color: '#FFF' },
  statsRow: { marginBottom: 16 },
  statsLabel: { fontSize: 14, color: '#666' },
  statsValue: { color: '#333', fontWeight: 'bold' },
  levelCard: { backgroundColor: '#BBDEFB', borderRadius: 16, padding: 16, marginBottom: 16 },
  levelHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 },
  levelTitle: { fontSize: 18, fontWeight: 'bold', color: '#1565C0' },
  expText: { fontSize: 12, color: '#1565C0' },
  progressBar: { height: 10, backgroundColor: 'rgba(21, 101, 192, 0.2)', borderRadius: 5, marginBottom: 8 },
  progress: { height: '100%', backgroundColor: '#1565C0', borderRadius: 5 },
  rankLabel: { fontSize: 12, color: '#1565C0' },
  rankValue: { fontWeight: 'bold' },
  leaderRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 20 },
  leaderAvatar: { width: 32, height: 32, borderRadius: 16 },
  leaderName: { marginLeft: 8, color: '#333', fontWeight: '500' },
  checkInCard: { backgroundColor: '#FFF', borderRadius: 16, padding: 16, marginBottom: 20, elevation: 2 },
  ...
  checkInTitle: { fontSize: 16, fontWeight: 'bold', marginLeft: 8, color: '#333' },
  taskLabel: { color: '#F57C00', fontSize: 12 },
  daysList: { marginBottom: 16 },
  dayItem: { alignItems: 'center', marginRight: 16 },
  checkCircle: { width: 32, height: 32, borderRadius: 16, borderWidth: 2, borderColor: '#E0E0E0', justifyContent: 'center', alignItems: 'center', marginBottom: 4 },
  checkedCircle: { backgroundColor: '#FFD54F', borderColor: '#FFD54F' },
  dayText: { fontSize: 10, color: '#666' },
  checkInButton: { backgroundColor: '#E0E0E0', paddingVertical: 10, borderRadius: 20, alignItems: 'center' },
  checkInButtonText: { color: '#FFF', fontWeight: 'bold' },
  sectionTitle: { fontSize: 18, fontWeight: 'bold', marginBottom: 12, color: '#333' },
  starsRow: { flexDirection: 'row', justifyContent: 'space-between' },
  starCard: { width: (width - 48) / 3, padding: 12, borderRadius: 12, alignItems: 'center' },
  starAvatar: { width: 40, height: 40, borderRadius: 20, marginBottom: 4 },
  starName: { fontSize: 10, color: '#FFF', fontWeight: 'bold' },
  emptyFamily: { flex: 1, justifyContent: 'center', alignItems: 'center', padding: 40 },
  emptyIcon: { width: 100, height: 100, marginBottom: 20, opacity: 0.5 },
  emptyText: { fontSize: 16, color: '#666', marginBottom: 24 },
  createButton: { backgroundColor: '#1565C0', paddingHorizontal: 32, paddingVertical: 12, borderRadius: 24 },
